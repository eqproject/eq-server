...
public class OrderAcceptServiceImpl extends ServiceImplExtend<OrderAcceptMapper, OrderAccept, OrderAcceptExample> implements OrderAcceptService {
    private final UserProductStockService userProductStockService;
    private final ProductService productService;
    private final BcTxRecordMapper bcTxRecordMapper;
    private final ProductCache productCache;
    private final ProductAcceptService productAcceptService;
    ...
    public ServieReturn<OrderAcceptVO> createAcceptOrderVO(SearchAcceptOrderVO searchAcceptOrderVO, User user) {
        ...
        BcTxRecord bcTxRecord = insertBx(productAll, userWallet.getAddress(), searchAcceptOrderVO.getNumber());
    ...
    private BcTxRecord insertBx(ProductAll productAll, String fromAddress, int number) {
        ...
        bcTxRecord.setBizType(BcAccountTypeEnum.ACCEPT.getCode());
        ...
        bcTxRecord.setInput(BcTxRecordInput.build(productAll, productAll.getAcceptAddress(), number));
