...
public class Base58 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String s = "5jfRuasbj3NXpHNQkM7vuukyUvmEG9XenwZKyZAxXrgHBymSCPBaSuG7ErxUqDt7GPUbxmTKZtajgfa3NxqMAyKHUA7QJtio7rdz82hD4279q8C";
		System.out.println("源字符串:"+s);
		System.out.println(Base58.encode(s.getBytes("utf-8")));;
		System.out.println(Base58.encode(s.getBytes("utf-8")));
		byte[] b = Base58.decode(Base58.encode(s.getBytes("utf-8")));
		System.out.println("源字符串:"+new String (b));
	}
}