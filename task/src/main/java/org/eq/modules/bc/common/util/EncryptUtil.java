...
public class EncryptUtil {
	...
	public static String key = "LmMGStGtOpF4~~xNyvYt54EQ==XX#$%()(#*!()!WR<><HHSMNsda24buF4xNyvbiDSFDdsf:>?<<dvcbnmiX#$%i;124f~~df>?N<:{LWPW~";
	...
	public static void main(String[] args) throws Exception {
		String source = "privbU7QWpnh1kVmBPZduWUBFusiNYPaBsUD2AuEnQ6nahZYmWz39dhb";  
