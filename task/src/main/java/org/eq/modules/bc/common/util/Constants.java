...
public class Constants {
    ...
    public static final int TASK_DELAY_SECONDS = 10 * 60;

    // ------------------------------------------------------------------
    // Misc, like Date, Alphabet, Numberic etc.
    ...
    // ------------------------------------------------------------------
    // activity
    public static final Integer DEFAULT_AVAILABLE_VOTE = 10;

    public static final int GROUP_EXPIRE_TIME_SECOND = 43200;
}
