...
public interface BaseService<Record, Example> {
     ...
     * @return List<Record>
     */
    PageInfo findListByRecordForPage(Record record, Map<String, Object> params);
     ...
     * @return
     */
    PageInfo findListByExampleForPage(Example example, Integer pageNum, Integer pageSize);
     ...
     * @return List<Record>
     */
    default PageInfo findListByRecordWithBLOBsForPage(Record record, Integer pageNum, Integer pageSize) {
     ...
     * @return
     */
    default PageInfo findListByExampleWithBLOBsForPage(Example example, Integer pageNum, Integer pageSize) {
